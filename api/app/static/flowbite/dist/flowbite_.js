...
(() => {
    ...
    const accordion = Accordion; // CONCATENATED MODULE: ./src/components/collapse.js
    ...
    /* harmony default export */
    const collapse = Collapse; // CONCATENATED MODULE: ./src/components/carousel.js
    ...
    var Carousel = /*#__PURE__*/ (function () {
        function Carousel() {
            ...
            this._options = carousel_objectSpread(
                carousel_objectSpread(carousel_objectSpread({}, carousel_Default), options),
                {},
                {
            ...
            },
            {
                ...
                value: function _setActiveItem(position) {
                    ...
                    if (this._indicators.length) {
                        ...
                        (_this$_indicators$pos = this._indicators[position].el.classList).add.apply(
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('[data-carousel]').forEach(function (carouselEl) {
            ...
            if (carouselEl.querySelectorAll('[data-carousel-item]').length) {
                carousel_toConsumableArray(carouselEl.querySelectorAll('[data-carousel-item]')).map(
                    function (carouselItemEl, position) {
                        items.push({
                            position: position,
                            el: carouselItemEl
                        });
    ...
    /* harmony default export */
    const carousel = Carousel; // CONCATENATED MODULE: ./src/components/dismiss.js
    ...
    /* harmony default export */
    const dismiss = Dismiss; // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/dom-utils/getWindow.js
...
*/
    ...
    var createPopper =
        /*#__PURE__*/ /* unused pure expression or super */ null && popperGenerator(); // eslint-disable-next-line import/no-unused-modules // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/modifiers/eventListeners.js
    ...
    function computeAutoPlacement(state, options) {
        ...
        var _options = options,
            ...
            allowedAutoPlacements =
                _options$allowedAutoP === void 0 ? enums_placements : _options$allowedAutoP;
    ...
    /* harmony default export */
    const dropdown = Dropdown; // CONCATENATED MODULE: ./src/components/modal.js
    ...
    /* harmony default export */
    const tabs = Tabs; // CONCATENATED MODULE: ./src/components/tooltip.js
