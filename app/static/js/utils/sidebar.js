...
if (!(window.location.pathname === "/chat")) {
    ...
    $.ajax({
        ...
        .done(function (data) {
            ...
            chat_sidebar.insertAdjacentHTML('beforeend', `<span id="notification_chat_sidebar" class="${parseInt(data) > 0 ? "" : "hidden"} overflow-hidden pointer-events-none text-center left-5 top-0 absolute text-sm bg-red-500 border-4 border-white dark:border-gray-800 rounded-full w-5 h-5">${data}</span>`);
