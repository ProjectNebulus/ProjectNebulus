    ...
    if (/\w+/.test(value)) {
        ...
        request.done((data) => {
            ...
            if (data === '0') {
                string = `
                    <li>
                        <div class="py-2.5 rounded-lg mx-auto block px-4 py-2 dark:hover:text-white">
                            No Results Found
                        </div>
                    </li>`;
            } else {
                ...
                for (let i = 0; i < datas.length; i++) {
                    ...
                    if (i % 4 === 3) {
                        ...
                        string += `
                    <li>
                        <div class="truncate py-2.5 rounded-lg block px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                ${pic}
