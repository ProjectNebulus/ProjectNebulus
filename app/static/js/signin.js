...
function startSchoology() {
    ...
    let newwindow2;
    request.done((data) => newwindow2 = window.open(data.replace('bins', domain), 'Authorize with Schoology2', 'height=400,width=800'))
    ...
    request.done(function (data) {
        ...
        if (data === "1" || data === "2") {
            ...
            if (data === "1")
                ...
                document.getElementById("error").innerHTML = "Login Failed. Reason: Your account is not connected to Schoology. Please signin normally and then connect your schoology account to signin with Schoology.";
