...
function changeInput() {
    ...
    if (!link.includes("https://") || !link.includes("schoology.")) {
        ...
        document.getElementById('step_2_button').classList.remove("bg-yellow-400", "hover:bg-yellow-500");
    } else {
        ...
        document.getElementById('step_2_button').classList.add("bg-yellow-400", "hover:bg-yellow-500");
