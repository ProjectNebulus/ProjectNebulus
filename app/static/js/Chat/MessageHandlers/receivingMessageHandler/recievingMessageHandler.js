...
function newMessageHandler(data) {
    ...
    if (chatID === data['chatID']) { // If the user is currently on the chat that the message was sent in, this functon is run to render the new message
        renderNewMessage(data);
    } else { // Otherwise, increment the notification div
