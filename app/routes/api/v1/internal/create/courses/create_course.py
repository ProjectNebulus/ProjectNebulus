...
def get_schoology() -> tuple[schoolopy.User, str, schoolopy.Schoology] | None:
...
def create_schoology_course(section, link, teacher, user, sc: schoolopy.Schoology = None, sync=False):
